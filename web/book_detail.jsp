        ...
        $(document).ready(function(){
            $('#update').on('click',function(){
                if(checkValidationAll){
                    $('#frm').attr('action','/Controller/bookController?cmd=update');
                    $('#frm').submit();
                }else{
...
<form action="" method="post" id="frm">
    <table>
        ...
        <tr>
            <td>도서번호</td>
            <td colspan="2">
                <input type="text" id="book_seq" name="book_seq" value="${copy.book_seq}">
            </td>
            <td id="message"></td>
        </tr>
        ...
        <tr>
            <td>ISBN</td>
            <td colspan="2">
                <input type="text" id="book_isbn" name="book_isbn" value="${copy.book_isbn}">
            </td>
            <td>
        ...
        <tr>
            <td>도서명</td>
            <td colspan="2">
                <input type="text" id="book_title" name="book_title" value="${copy.book_title}">
            </td><td></td>
        </tr>
        ...
        <tr>
            <td>저자/역자</td>
            <td colspan="2">
                <input type="text" id="book_author" name="book_author" value="${copy.book_author}">
            </td><td></td>
        </tr>
        ...
        <tr>
            <td>출판사</td>
            <td colspan="2">
                <input type="text" id="book_publisher" size="35" name="book_publisher" value="${copy.book_publisher}">
            </td><td></td>
        </tr>
        ...
        <tr>
            <td>출판일</td>
            <td colspan="2">
                <input type="text" id="book_published_date" size="35" name="book_published_date" value="${copy.book_published_date}">
            </td>
            <td></td>
        </tr>
        </c:forEach>
